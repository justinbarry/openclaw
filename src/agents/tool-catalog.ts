...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    id: "linear_issue",
    label: "linear_issue",
    description: "Create, read, update, or archive Linear issues",
    sectionId: "linear",
    profiles: [],
    includeInOpenClawGroup: true,
  },
  ...
  },
  {
    id: "linear_queue",
    label: "linear_queue",
    description: "Inspect Linear cycles (sprints/queues)",
    sectionId: "linear",
    profiles: [],
    includeInOpenClawGroup: true,
  },
  ...
  },
  {
    ...
    description: "Manage relations between Linear issues",
    sectionId: "linear",
    profiles: [],
    includeInOpenClawGroup: true,
  },
