...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    id: "linear",
    label: "linear",
    description: "Full Linear GraphQL API access (queries and mutations)",
    sectionId: "linear",
    profiles: [],
    includeInOpenClawGroup: true,
  },
  {
    ...
    description: "Look up a Linear project by name, URL slug, or UUID",
    sectionId: "linear",
    profiles: [],
    includeInOpenClawGroup: true,
  },
  {
    ...
    description: "Update a Linear project description or content body",
    sectionId: "linear",
    profiles: [],
    includeInOpenClawGroup: true,
  },
  ...
  {
    id: "linear_find_issue",
    label: "linear_find_issue",
    description: "Find Linear issues by text search or identifier (e.g. ENG-42)",
    sectionId: "linear",
    profiles: [],
    includeInOpenClawGroup: true,
  },
  {
    ...
    description: "Update fields on a Linear issue by UUID or identifier",
    sectionId: "linear",
    profiles: [],
    includeInOpenClawGroup: true,
  },
  {
    ...
    description: "Get a Linear team by key or name, including workflow states and members",
    sectionId: "linear",
    profiles: [],
    includeInOpenClawGroup: true,
  },
  {
    id: "linear_search_docs",
    label: "linear_search_docs",
    description: "Search Linear documents by keyword",
    sectionId: "linear",
    profiles: [],
    includeInOpenClawGroup: true,
  },
  {
    id: "linear_manage_doc",
    label: "linear_manage_doc",
    description: "Create or update a Linear document attached to a project or issue",
    sectionId: "linear",
    profiles: [],
    includeInOpenClawGroup: true,
  },
